...
<xsl:import href="@maven.sdocbook.stylesheets.dir@/html/chunk.xsl" />
...
<xsl:template name="chunk-element-contenta">
 <xsl:param name="prev"/>
 <xsl:param name="next"/>
 ...
 <xsl:if test="$build.time='-1'">
   <xsl:message>ERROR: You must supply the stylesheet parameter
"build.time"</xsl:message>
 </xsl:if>
                   ...
                   <table border="0" cellspacing="0" cellpadding="0">
                     <tbody>
                       <tr>
                         ...
                         <td class="sublogo" valign="bottom">Java Source
Code Formatter Beautifier Pretty Printer</td>
                       </tr>
                     </tbody>
                   </table>
                 </td>
