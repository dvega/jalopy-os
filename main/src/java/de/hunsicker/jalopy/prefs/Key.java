...
/**
 * A key for storing a value in the Jalopy preferences.
 *
 * @author <a href="http://jalopy.sf.net/contact.html">Marco Hunsicker</a>
 * @version $Revision$
 *
 * @see de.hunsicker.jalopy.prefs.Preferences
 * @see de.hunsicker.jalopy.prefs.ConventionKeys
 * @since 1.0b8
 * @deprecated Replaced by {@link de.hunsicker.jalopy.storage.Convention.Key}
 */
