...
/**
 * Parser for the Sun Java language. Heavily based on the public domain grammar written
 * by <a href="mailto:parrt@jguru.com">Terence Parr </a> et al. See <a
 * href="http://www.antlr.org/resources.html"> http://www.antlr.org/resources.html</a>
 * for more info.
 * 
 * <p>
    ...
    implements Parser
{
    ...
    /**
     * Were the import nodes of the identifiers we stripped qualification yet added to
     * the tree?
     */
     ...
     *
     * @return qualified identifiers. Returns an empty array if no qualified identifiers
     *         could be found.
     */
    ...
    /**
     * Sets whether qualification of qualified identifiers should be stripped. (not
     * implemented yet)
     *
     ...
     *
     * @return unqualified identifiers. Returns an empty array if no unqualified
            ...
            switch (LA(1))
            {
                ...
                case JavaTokenTypes.RPAREN :
                {
                    if (inputState.guessing == 0)
                    {
                        ...
                        argList_AST =
                            (JavaNode) astFactory.create(JavaTokenTypes.ELIST, STR_ELIST);
                        ...
                        (JavaNode) astFactory.make(
                            (new ASTArray(2)).add(
                                (JavaNode) astFactory.create(
                                    JavaTokenTypes.TYPE, STR_TYPE)).add(
                                builtInTypeSpec_AST));
                }

                currentAST.root = builtInTypeSpec_AST;
                currentAST.child =
                    ((builtInTypeSpec_AST != null)
            ...
            if (inputState.guessing == 0)
            {
                ...
                caseSList_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(2)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.CASESLIST, STR_CASESLIST)).add(
                            caseSList_AST));
                currentAST.root = caseSList_AST;
                currentAST.child =
                    ((caseSList_AST != null) && (caseSList_AST.getFirstChild() != null))
            ...
            if (inputState.guessing == 0)
            {
                ...
                casesGroup_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(2)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.CASE_GROUP, "CASE_GROUP")).add(
                            casesGroup_AST));
                currentAST.root = casesGroup_AST;
                currentAST.child =
                    ((casesGroup_AST != null) && (casesGroup_AST.getFirstChild() != null))
...
_loop60: 
    ...
    /**
     * A declaration is the creation of a reference or primitive-type variable Create a
     * separate Type/Var tree for each var in the var list.
     *
     * @throws RecognitionException DOCUMENT ME!
     * @throws TokenStreamException DOCUMENT ME!
     */
        ...
        { // for error handling
            ...
            if (inputState.guessing == 0)
            {
                ...
                expression_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(2)).add(
                            (JavaNode) astFactory.create(JavaTokenTypes.EXPR, STR_EXPR))
                         .add(expression_AST));
                currentAST.root = expression_AST;
                currentAST.child =
                    ((expression_AST != null) && (expression_AST.getFirstChild() != null))
        ...
        { // for error handling
                            ...
                            if (inputState.guessing == 0)
                            {
                                ...
                                field_AST =
                                    (JavaNode) astFactory.make(
                                        (new ASTArray(4)).add(
                                            (JavaNode) astFactory.create(
                                                JavaTokenTypes.CTOR_DEF, "CTOR_DEF"))
                                         .add(mods_AST).add(h_AST).add(s_AST));
                                        ...
                                        (JavaNode) astFactory.make(
                                            (new ASTArray(10)).add(
                                                (JavaNode) astFactory.create(
                                                    ...
                                                    "METHOD_DEF")).add(mods_AST)
                                             .add((JavaNode) astFactory.make(
                                                    (new ASTArray(2)).add(
                                                        (JavaNode) astFactory.create(
                                                            JavaTokenTypes.TYPE, STR_TYPE))
                                                     .add(rt_AST))).add(idd_AST)
                                             .add(lp_AST).add(param_AST).add(rp_AST)
                                             .add(tc_AST).add(s2_AST).add(semim_AST));
                ...
                && (LA(2) == JavaTokenTypes.LCURLY))
            {
                ...
                if (inputState.guessing == 0)
                {
                    ...
                    currentAST.root = field_AST;
                    currentAST.child =
                        ((field_AST != null) && (field_AST.getFirstChild() != null))
                        ? field_AST.getFirstChild()
                        : field_AST;
                    currentAST.advanceChildToEnd();
                }
                ...
                if (inputState.guessing == 0)
                {
                    ...
                    field_AST =
                        (JavaNode) astFactory.make(
                            (new ASTArray(2)).add(
                                (JavaNode) astFactory.create(
                                    JavaTokenTypes.INSTANCE_INIT, STR_INSTANCE_INIT)).add(
                                s4_AST));
            ...
            if (inputState.guessing == 0)
            {
                ...
                forCond_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(2)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.FOR_CONDITION, "FOR_CONDITION")).add(
                            forCond_AST));
                currentAST.root = forCond_AST;
                currentAST.child =
                    ((forCond_AST != null) && (forCond_AST.getFirstChild() != null))
            ...
            if (inputState.guessing == 0)
            {
                ...
                forInit_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(2)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.FOR_INIT, "FOR_INIT")).add(forInit_AST));
                currentAST.root = forInit_AST;
                currentAST.child =
                    ((forInit_AST != null) && (forInit_AST.getFirstChild() != null))
            ...
            if (inputState.guessing == 0)
            {
                ...
                forIter_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(2)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.FOR_ITERATOR, "FOR_ITERATOR")).add(
                            forIter_AST));
                currentAST.root = forIter_AST;
                currentAST.child =
                    ((forIter_AST != null) && (forIter_AST.getFirstChild() != null))
...
_loop23: 
            ...
            if (inputState.guessing == 0)
            {
                ...
                identifier_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(1)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.IDENT, _buf.toString())));
                ...
                currentAST.child =
                    ((identifier_AST != null) && (identifier_AST.getFirstChild() != null))
    ...
    /**
     * Our qualified package identifier. We need this rule because all other identifiers
     * will be made unqualified (depending on the stripQualification switch).
     *
     * @throws RecognitionException DOCUMENT ME!
     * @throws TokenStreamException DOCUMENT ME!
     */
            ...
            if (inputState.guessing == 0)
            {
                ...
                implementsClause_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(2)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.IMPLEMENTS_CLAUSE, "IMPLEMENTS_CLAUSE"))
            ...
            if (inputState.guessing == 0)
            {
                ...
                interfaceExtends_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(2)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.EXTENDS_CLAUSE, STR_EXTENDS_CLAUSE)).add(
                            interfaceExtends_AST));
                currentAST.root = interfaceExtends_AST;
                currentAST.child =
                    ((interfaceExtends_AST != null)
            ...
            if (inputState.guessing == 0)
            {
                ...
                modifiers_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(2)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.MODIFIERS, STR_MODIFIERS)).add(
                            modifiers_AST));
                currentAST.root = modifiers_AST;
                currentAST.child =
                    ((modifiers_AST != null) && (modifiers_AST.getFirstChild() != null))
...
_loop196: 
    ...
    /**
     * object instantiation. Trees are built as illustrated by the following input/tree
     * pairs:
     * <pre>
     *  new T()
     * 
            ...
            if (inputState.guessing == 0)
            {
                ...
                parameterDeclaration_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(4)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.PARAMETER_DEF, "PARAMETER_DEF")).add(
                            pm_AST)
                         .add((JavaNode) astFactory.make(
                                (new ASTArray(2)).add(
                                    (JavaNode) astFactory.create(
                                        JavaTokenTypes.TYPE, STR_TYPE)).add(pd_AST))).add(
                            id_AST));

                _references.defineVariable(
                    id.getText().intern(), parameterDeclaration_AST);

                currentAST.root = parameterDeclaration_AST;
                currentAST.child =
                    ((parameterDeclaration_AST != null)
            ...
            if (inputState.guessing == 0)
            {
                ...
                parameterDeclarationList_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(2)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.PARAMETERS, STR_PARAMETERS)).add(
                            parameterDeclarationList_AST));
            ...
            if (inputState.guessing == 0)
            {
                ...
                parameterModifier_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(2)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.MODIFIERS, STR_MODIFIERS)).add(f_AST));
                currentAST.root = parameterModifier_AST;
                currentAST.child =
                    ((parameterModifier_AST != null)
            ...
            if (inputState.guessing == 0)
            {
                if (t != null)
                {
                    _references.addReference(
                        buf.toString().intern(), (JavaNode) currentAST.root);
                }
            ...
            if (inputState.guessing == 0)
            {
                ...
                variableDeclarator_AST =
                    (JavaNode) astFactory.make(
                        (new ASTArray(5)).add(
                            (JavaNode) astFactory.create(
                                JavaTokenTypes.VARIABLE_DEF, "VARIABLE_DEF")).add(mods)
                         .add((JavaNode) astFactory.make(
                                (new ASTArray(2)).add(
                                    (JavaNode) astFactory.create(
                                        JavaTokenTypes.TYPE, STR_TYPE)).add(d_AST)))
...
_loop65: 
    ...
    /**
     * Attaches the hidden tokens associated to either the modifiers or type to the
     * imaginary node.
     *
     ...
     */
    private void attachStuffBefore(
        JavaNode node,
        JavaNode modifiers,
        JavaNode type)
    {
    ...
    /**
     * Attaches the hidden tokens from the specified compound statement to its imaginary
     * node.
     *
     * @param node a INSTANCE_INIT node.
     * @param statement a SLIST node.
     */
    private void attachStuffBeforeCompoundStatement(
        JavaNode node,
        JavaNode statement)
    {
    ...
    /**
     * Attaches the hidden tokens associated to either the modifiers or keyword to the
     * imaginary node.
     *
     ...
     */
    private void attachStuffBeforeCtor(
        JavaNode node,
        JavaNode modifiers,
        JavaNode keyword)
    {
