  ...
  astFactory = new ASTFactory(getTokenTypeToASTClassMap());
	...
	public final void enumConstant() throws RecognitionException, TokenStreamException {
		...
		if ( inputState.guessing==0 ) {
			...
			enumConstant_AST = (JavaNode)astFactory.make( (new ASTArray(5)).add((JavaNode)astFactory.create(ENUM_CONSTANT_DEF,"ENUM_CONSTANT_DEF")).add(an_AST).add(i_AST).add(a_AST).add(b_AST));
		...
		case LITERAL_enum:
		{
			...
			case LITERAL_double:
			{
				...
				if ((LA(1)==IDENT) && (LA(2)==LPAREN)) {
					...
					if ( inputState.guessing==0 ) {
						enumConstantField_AST = (JavaNode)currentAST.root;
						enumConstantField_AST = (JavaNode)astFactory.make( (new ASTArray(8)).add((JavaNode)astFactory.create(METHOD_DEF,"METHOD_DEF")).add(mods_AST).add(tp_AST).add((JavaNode)astFactory.make( (new ASTArray(2)).add((JavaNode)astFactory.create(TYPE,"TYPE")).add(rt_AST))).add(tmp99_AST).add(param_AST).add(tc_AST).add(s2_AST));
 ...
 */
	...
	public final void unaryExpression() throws RecognitionException, TokenStreamException {
		...
		case MINUS:
		{
			...
			match(MINUS);
			if ( inputState.guessing==0 ) {
				tmp204_AST.setType(UNARY_MINUS);
			}
			unaryExpression();
			astFactory.addASTChild(currentAST, returnAST);
			unaryExpression_AST = (JavaNode)currentAST.root;
 ...
 */
	...
	public final void constant() throws RecognitionException, TokenStreamException {
		...
		case NUM_LONG:
		{
			JavaNode tmp246_AST = null;
			tmp246_AST = (JavaNode)astFactory.create(LT(1));
		...
		case NUM_DOUBLE:
		{
			JavaNode tmp247_AST = null;
			tmp247_AST = (JavaNode)astFactory.create(LT(1));
