...
public abstract class InternalJavaLexer extends antlr.CharScanner implements JavaTokenTypes, TokenStream
 {
...
public InternalJavaLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public InternalJavaLexer(Reader in) {
	this(new CharBuffer(in));
}
public InternalJavaLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public InternalJavaLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("byte", this), new Integer(91));
	literals.put(new ANTLRHashString("public", this), new Integer(100));
	literals.put(new ANTLRHashString("case", this), new Integer(132));
	literals.put(new ANTLRHashString("short", this), new Integer(93));
	literals.put(new ANTLRHashString("break", this), new Integer(125));
	literals.put(new ANTLRHashString("while", this), new Integer(123));
	literals.put(new ANTLRHashString("new", this), new Integer(168));
	literals.put(new ANTLRHashString("instanceof", this), new Integer(155));
	literals.put(new ANTLRHashString("implements", this), new Integer(116));
	literals.put(new ANTLRHashString("synchronized", this), new Integer(105));
	literals.put(new ANTLRHashString("float", this), new Integer(95));
	literals.put(new ANTLRHashString("package", this), new Integer(73));
	literals.put(new ANTLRHashString("return", this), new Integer(127));
	literals.put(new ANTLRHashString("throw", this), new Integer(129));
	literals.put(new ANTLRHashString("null", this), new Integer(167));
	literals.put(new ANTLRHashString("threadsafe", this), new Integer(104));
	literals.put(new ANTLRHashString("protected", this), new Integer(101));
	literals.put(new ANTLRHashString("class", this), new Integer(111));
	literals.put(new ANTLRHashString("throws", this), new Integer(118));
	literals.put(new ANTLRHashString("do", this), new Integer(124));
	literals.put(new ANTLRHashString("strictfp", this), new Integer(46));
	literals.put(new ANTLRHashString("super", this), new Integer(83));
	literals.put(new ANTLRHashString("transient", this), new Integer(102));
	literals.put(new ANTLRHashString("native", this), new Integer(103));
	literals.put(new ANTLRHashString("interface", this), new Integer(112));
	literals.put(new ANTLRHashString("final", this), new Integer(44));
	literals.put(new ANTLRHashString("if", this), new Integer(121));
	literals.put(new ANTLRHashString("double", this), new Integer(97));
	literals.put(new ANTLRHashString("volatile", this), new Integer(106));
	literals.put(new ANTLRHashString("assert", this), new Integer(130));
	literals.put(new ANTLRHashString("catch", this), new Integer(135));
	literals.put(new ANTLRHashString("try", this), new Integer(133));
	literals.put(new ANTLRHashString("enum", this), new Integer(113));
	literals.put(new ANTLRHashString("int", this), new Integer(94));
	literals.put(new ANTLRHashString("for", this), new Integer(131));
	literals.put(new ANTLRHashString("extends", this), new Integer(82));
	literals.put(new ANTLRHashString("boolean", this), new Integer(90));
	literals.put(new ANTLRHashString("char", this), new Integer(92));
	literals.put(new ANTLRHashString("private", this), new Integer(99));
	literals.put(new ANTLRHashString("default", this), new Integer(115));
	literals.put(new ANTLRHashString("false", this), new Integer(166));
	literals.put(new ANTLRHashString("this", this), new Integer(117));
	literals.put(new ANTLRHashString("static", this), new Integer(76));
	literals.put(new ANTLRHashString("abstract", this), new Integer(45));
	literals.put(new ANTLRHashString("continue", this), new Integer(126));
	literals.put(new ANTLRHashString("finally", this), new Integer(134));
	literals.put(new ANTLRHashString("else", this), new Integer(122));
	literals.put(new ANTLRHashString("import", this), new Integer(75));
	literals.put(new ANTLRHashString("void", this), new Integer(89));
	literals.put(new ANTLRHashString("switch", this), new Integer(128));
	literals.put(new ANTLRHashString("true", this), new Integer(165));
	literals.put(new ANTLRHashString("long", this), new Integer(96));
}
...
tryAgain:
	...
	protected final void mSPECIAL_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			// nongreedy exit test
			if ((LA(1)=='/') && (LA(2)=='/') && (LA(3)=='J') && (LA(4)=='+')) break _loop373;
